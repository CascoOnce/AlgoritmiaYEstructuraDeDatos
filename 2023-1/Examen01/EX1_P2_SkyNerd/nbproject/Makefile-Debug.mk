...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ex1_p2_skynerd.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ex1_p2_skynerd.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ex1_p2_skynerd ${OBJECTFILES} ${LDLIBSOPTIONS}
